...
const donorHomeFeatures = [
  ...
  DonorHomeFeature(
    ...
    items: [
      'Sleep well the night before your donation so your body is rested.',
      'Drink extra water before donating and keep drinking fluids after donation.',
      'Eat a healthy meal before your appointment. Do not donate on an empty stomach.',
      'Choose iron-rich foods such as fish, eggs, beans, lentils, spinach, or iron-fortified cereal.',
      'Avoid very fatty foods before donation because they can affect blood testing.',
      'Bring your NIC, donor card, or another valid ID to the donation center.',
      'Wear comfortable clothing with sleeves that can roll above your elbow.',
      'Relax during donation. Tell staff immediately if you feel dizzy, cold, weak, or unwell.',
      'After donating, rest for a short time and have the snack or drink provided by the center.',
      'Avoid heavy lifting, strenuous exercise, and hot baths for the rest of the day.',
      'Keep the bandage on as advised. If bleeding starts, press the area and raise your arm.',
      'If you feel lightheaded later, lie down with your feet raised until you feel better.',
    ],
  ),
  DonorHomeFeature(
    title: 'Achievements',
